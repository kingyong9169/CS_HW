...
%token	ADD SUB MUL DIV ASSGN ID NUM STMTEND START END ID2 RPARA LPARA MINUS 
...
{
	printf("\nsample edragon compiler v1.1\n");
	printf("(C) Copyright by Dong Yong Kim (drdragon777@naver.com), 2021.\n");
